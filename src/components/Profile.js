    ...
    <div className=' info '>
      <div className=' profile '>
        ...
        <div className='img_div'>
          <div>
            <img src={image} alt="ELie" />
            <h1>Elie Kuradusenge</h1>
            <h2>Software developer</h2>
          </div>
          <div className='icons'>
            <section>
              <span><FontAwesomeIcon icon={faLocationPin} /><p>Kigali, Rwanda</p></span>
              <span><FontAwesomeIcon icon={faEnvelope} /><p>elkuradusenge@gmail.com</p> </span>
              <span><FontAwesomeIcon icon={faPhone} /> <p>+250792568899</p></span>
            </section>
            <div>
              <Link target='_blank' to='https://github.com/elijahladdie'>
              ...
              <Link target='_blank' to='https://www.instagram.com/elijah_laddie/'>
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
              ...
              <Link target='_blank' to='https://twitter.com/elijahladdie'>
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
      ...
      <div className='context'>
        <h1>Bio</h1>
        <p>
          I am fullstack software engineer and information technology 
          enthusiast with deep interest in frontend development, and backend development in other to create applications that are capable of solving real world problems using softwares
          I code as hobbie and proffesion as it was thing I liked to do since I was young.
          I hold <b>High school Diploma in Software development, </b> and experience from internships and apprenticeships.
        ...
        <ul>
          <li>Javascript: ReactJs, redux, NodeJs, Typescript, NextJS</li>
          <li>Php</li>
          <li>Html and css</li>
