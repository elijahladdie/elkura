...
import image from '../assets/img/mine_.png'
  ...
  return (
    <div className='content info '>
        ...
        <div className='img_div'>
          ...
          <div className='icons'>
            ...
            <div>
                ...
                <a href='https://www.linkedin.com/in/elikuradusenge/'>
                  <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
                ...
                <a href='https://www.instagram.com/elijah_laddie/'>
                  <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
                ...
                <a href='https://twitter.com/elijahladdie'>
                  <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
      ...
      <div className='context'>
        <h1>Bio</h1>
        <p>
          I am  Full-stack  software developer and technology enthusiast with deep interest and experience in front-end development.
          Constant growth is what I like in software development industry and it's my main motivator that keeps me open to learn new technologies.
           I hold <b>Diploma in Software development from Collegio SAMZ TSS from RTB~ Technical Schools in Rwanda </b>
          and I have good experience in software development industry.

        </p>
        <h1>Technical skills</h1>
        
          <ul>
            <li>Javascript: ReactJs,redux,NodeJs</li>
            <li>Php</li>
            <li>Html and css</li>
